...
public class JF_Aviso_CRUD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cpQuery = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Cp c");
        cpList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : cpQuery.getResultList();
        cpQuery1 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Cp c");
        cpList1 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : cpQuery1.getResultList();
        ...
        cpQuery2 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT c FROM Cp c");
        cpList2 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : cpQuery2.getResultList();
        avisoQuery = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT a FROM Aviso a");
        avisoList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : avisoQuery.getResultList();
...
/*        JF_Aviso_CRUD vista_Aviso = new JF_Aviso_CRUD();
 ...
 /*       JF_Aviso_CRUD vista_Aviso = new JF_Aviso_CRUD();
    ...
    private java.util.List<proyectofincurso.Aviso> avisoList;
    private javax.persistence.Query avisoQuery;
    private java.util.List<proyectofincurso.Cp> cpList;
    private java.util.List<proyectofincurso.Cp> cpList1;
    private java.util.List<proyectofincurso.Cp> cpList2;
    private javax.persistence.Query cpQuery;
    private javax.persistence.Query cpQuery1;
    private javax.persistence.Query cpQuery2;
