...
public class JF_Trabajador_CRUD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        trabajadorQuery = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM Trabajador t");
        trabajadorList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : trabajadorQuery.getResultList();
        trabajadorQuery1 = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM Trabajador t");
        trabajadorList1 = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : trabajadorQuery1.getResultList();
    ...
    private java.util.List<proyectofincurso.Trabajador> trabajadorList;
    private java.util.List<proyectofincurso.Trabajador> trabajadorList1;
    private javax.persistence.Query trabajadorQuery;
    private javax.persistence.Query trabajadorQuery1;
